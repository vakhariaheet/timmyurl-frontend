...
const TermsOfService: React.FC<TermsOfServiceProps> = () => {
	return (
		<div>
			...
			<p>Welcome to TimmyURL!</p>
			<p>
				These terms and conditions outline the rules and regulations for the use
				of Timmyurl's Website, located at{' '}
				<a href='https://timmyurl.in'>https://timmyurl.in.</a>.
			</p>
			<p>
				By accessing this website, we assume you accept these terms and
				conditions. Do not continue to use TimmyURL if you do not agree to take
				all of the terms and conditions stated on this page.
			</p>
			<h4>Cookies:</h4>
			<p>
				The website uses cookies to help personalize your online experience. By
				accessing TimmyURL, you agreed to use the required cookies.
			</p>
			<p>
			...
			<h4>License:</h4>
			<p>
				Unless otherwise stated, Timmyurl and/or its licensors own the
				intellectual property rights for all material on TimmyURL. All
				intellectual property rights are reserved. You may access this from
				TimmyURL for your own personal use subjected to restrictions set in
				these terms and conditions.
			</p>
			<p>You must not:</p>
			<ul>
				<li>Copy or republish material from TimmyURL</li>
				<li>Sell, rent, or sub-license material from TimmyURL</li>
				<li>Reproduce, duplicate or copy material from TimmyURL</li>
				<li>Redistribute content from TimmyURL</li>
			</ul>
			<p>This Agreement shall begin on the date hereof.</p>
			<p>
				Parts of this website offer users an opportunity to post and exchange
				opinions and information in certain areas of the website. Timmyurl does
				not filter, edit, publish or review Comments before their presence on
				the website. Comments do not reflect the views and opinions of Timmyurl,
				...
				permitted by applicable laws, Timmyurl shall not be liable for the
			...
			<p>
				Timmyurl reserves the right to monitor all Comments and remove any
			...
			<p>
				You hereby grant Timmyurl a non-exclusive license to use, reproduce,
			...
			<p>
				...
				the hyperlink compensates the absence of Timmyurl; and (d) the link is
			...
			<p>
				...
				e-mail to Timmyurl. Please include your name, your organization name,
			...
			<p>
				No use of Timmyurl's logo or other artwork will be allowed for linking
